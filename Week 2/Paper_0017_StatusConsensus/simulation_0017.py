...
class Config:
    ...
    SMOKE_WORKBOOK = SCRIPT_DIR / "SMOKE_Stroube2024Report_0017.xlsx"
    REGRESSION_TXT_DIR = SCRIPT_DIR / "regression_txt_outputs"
    PROGRESS_LOG = SCRIPT_DIR / "simulation_0017_progress.log"
...
def main():
    ...
    Config.PROGRESS_LOG = SCRIPT_DIR / f"simulation_0017_progress_{args.mode}.log"
