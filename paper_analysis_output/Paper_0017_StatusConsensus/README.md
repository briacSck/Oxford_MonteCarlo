...
to build `DATA.csv`, then proceeds with simulation. Structured logs are written to
`logs/` (gitignored). Per-iteration regression outputs are written to `regression_outputs/`.
